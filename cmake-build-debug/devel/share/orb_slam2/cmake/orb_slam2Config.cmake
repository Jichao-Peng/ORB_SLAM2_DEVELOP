...
if("TRUE" STREQUAL "TRUE")
  set(orb_slam2_SOURCE_PREFIX /home/leo/Desktop/orb_slam2_project/src/orb_slam2)
  set(orb_slam2_DEVEL_PREFIX /home/leo/Desktop/orb_slam2_project/src/cmake-build-debug/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'orb_slam2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'leo <leo@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'orb_slam2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leo/Desktop/orb_slam2_project/src/orb_slam2/${idir}'.  Ask the maintainer 'leo <leo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/leo/Desktop/orb_slam2_project/src/cmake-build-debug/devel/lib;/opt/ros/indigo/lib)
